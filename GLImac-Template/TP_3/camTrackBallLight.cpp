...
int main(int argc, char** argv) {
    ...
    //To execute : ./TP_3/TP_3_camTrackBall 3D.vs.glsl directionallight.fs.glsl
     ...
     *********************************/
        ...
        std::unique_ptr<Image> EarthMap=loadImage("/home/6im2/pcharles/Documents/OpenGL/GLImac-Template/assets/textures/EarthMap.jpg");
        std::unique_ptr<Image> MoonMap=loadImage("/home/6im2/pcharles/Documents/OpenGL/GLImac-Template/assets/textures/MoonMap.jpg");
        std::unique_ptr<Image> CloudMap=loadImage("/home/6im2/pcharles/Documents/OpenGL/GLImac-Template/assets/textures/CloudMap.jpg");
    ...
    while(!done) {
         ...
         *********************************/
         ...
         glm::mat4 Mrotate = glm::rotate(glm::mat4(1.0), windowManager.getTime(), glm::vec3(0.0f, 1.0f, 0.0f)); 
