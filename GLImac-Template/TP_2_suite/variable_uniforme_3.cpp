...
int main(int argc, char** argv) {
    ...
    GLint id_unif = glGetUniformLocation(program.getGLId(), "uModelMatrix");
    ...
    while(!done) {
         ...
         *********************************/
         ...
         glm::mat3 M_rotate = rotate(rotate_utime);

         glUniformMatrix3fv(id_unif, 1, GL_FALSE, glm::value_ptr(M_rotate));
